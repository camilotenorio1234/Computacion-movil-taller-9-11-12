package com.proyect_chidos.app_sonripluss_app.model;
...
public class Client {
    ...
    public Client(String tipo_id, Long id_docu, String nombres, String primer_apellido, String segundo_apellido, String sexo, int edad_actual, String estado_civil, String ocupacion, String dir_residencia, Long num_tel, String lugar_de_residencia, String motivo_consulta, String email) {
